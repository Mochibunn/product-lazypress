            ...
            {!submitted && (
                ...
                >
                    ...
                    <h3 className="text-black text-center text-xl">
                        Fill out the form to start the conversation <br /> right
                        away we will get back to you
                    </h3>
                            ...
                            >
                                ...
                                >
                                    ...
                                    {errors?.lastName?.type === "minLength" && (
                                        <p style={{ color: "red" }}>
                                            &#9888; Last name must have minimum
                                            3 characters
                                        </p>
                                    )}
                                    {errors?.lastName?.type === "maxLength" && (
                                        <p style={{ color: "red" }}>
                                            &#9888; Last name can not exceed
                                ...
                                >
                                    ...
                                    {errors?.textarea?.type === "minLength" && (
                                        <p style={{ color: "red" }}>
                                            &#9888; Message must have minimum 30
                                            characters
                                        </p>
                                    )}
                                    {errors?.textarea?.type === "maxLength" && (
                                        <p style={{ color: "red" }}>
                                            &#9888; Message can not exceed more
                                            than 200 characters
                                        </p>
                                    )}
                                </label>
